...
function3_input_button = Button(function2_input_frame, text="Function 3")
function3_input_button.grid(row=0, column=1)
function3_input_button.bind('<Button-1>', procurements_browse_clicked)
...
function4_input_button = Button(function2_input_frame, text="Function 4")
function4_input_button.grid(row=0, column=2)
function4_input_button.bind('<Button-1>', procurements_browse_clicked)
...
function5_input_button = Button(function2_input_frame, text="Function 5")
function5_input_button.grid(row=0, column=3)
function5_input_button.bind('<Button-1>', procurements_browse_clicked)
