...
def save():
    ...
    try:
        Create_Folder()'''Read the CSV file and export each government agency's procurement details into one folder and sort the details by tender number in txt file'''
